...
<div class="container">
    <form method="POST">
        <div class="input-group w-50 d-flex flex-column">
            <label class="text text-light fs-4">Enter Your Notes Description</label>
            <textarea class="w-100 rounded mt-2 py-2 px-3" style="resize: none; height:200px; overflow-y:scroll;" aria-label="With textarea" placeholder="Enter Your Note Here....."></textarea>
